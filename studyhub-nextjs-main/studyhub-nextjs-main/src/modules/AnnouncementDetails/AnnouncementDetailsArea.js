...
import Announcements from "@/data/assignments.json";
import Instructors from "@/data/instructors.json";
import Image from "next/image";

export default function AnnouncementDetailsArea({item}) {
	if (!item) {
					...
					<div className="row">
						<div className="col-lg-8">
							<div className="rts-events-details-area-information quiz-details">
								<h5 className="title">About The Announcement</h5>
								<p className="disc">
						...
						<div className="col-lg-12">
							<div className="title-between-area">
								<div className="title-area-left-style">
									<h2 className="title">Announcement Instructors</h2>
								</div>
							</div>
						</div>
					</div>
